...
CKEDITOR.dialog.add("radio", function(c) {
    return {
        ...
        minHeight: 140,
        getModel: function(a) {
            return (a = a.getSelection().getSelectedElement()) && "input" == a.getName() && "radio" == a.getAttribute("type") ? a : null
        },
        onShow: function() {
                ...
                commit: function(a) {
                    ...
                    if (CKEDITOR.env.ie) {
                        ...
                        d != e && (d = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"radio"' +
                            (e ? ' checked\x3d"checked"' : "") + "\x3e\x3c/input\x3e", c.document), b.copyAttributes(d, {
                            type: 1,
                            checked: 1
                        }), d.replace(b), e && d.setAttribute("checked", "checked"), c.getSelection().selectElement(d), a.element = d)
